...
Function LoadDecals(isMultiplayer% = False)
	...
	If (Not isMultiplayer) Then
		For i = DECAL_DECAY To DECAL_173BLOOD3
			DecalTextures[i] = LoadTexture_Strict("GFX\Decals\decal"+(i+1)+".png", 1+2, 2)
		Next
		DecalTextures[DECAL_PAPERSTRIPS] = LoadTexture_Strict("GFX\items\Icons\INV_paper_strips.jpg", 1+2, 2)
		For i = DECAL_PD1 To DECAL_PD5
			DecalTextures[i] = LoadTexture_Strict("GFX\Decals\decalpd"+(i-7)+".jpg", 1+2, 2)
		Next
		DrawLoading(22, False, "", "DECALS PACK #1")
		For i = DECAL_BLOODDROP1 To DECAL_BLOODDROP2
			DecalTextures[i] = LoadTexture_Strict("GFX\Decals\blooddrop"+(i-14)+".png", 1+2, 2)
		Next
		DecalTextures[DECAL_BLOODPOOL] = LoadTexture_Strict("GFX\Decals\decal8.png", 1+2, 2)
		DecalTextures[DECAL_PD6] = LoadTexture_Strict("GFX\Decals\decalpd6.dc", 1+2, 2)
		DrawLoading(24, False, "", "DECALS PACK #2")
		DecalTextures[DECAL_CRYSTAL] = LoadTexture_Strict("GFX\Decals\decal19.png", 1+2, 2)
		DecalTextures[DECAL_FOAM] = LoadTexture_Strict("GFX\Decals\decal427.png", 1+2, 2)
		DecalTextures[DECAL_1079] = LoadTexture_Strict("GFX\Decals\decal1079.png", 1+2, 2)
	Else
		DecalTextures[DECAL_035] = LoadTexture_Strict("GFX\Decals\decal035.png", 1+2, 2)
	EndIf
	For i = DECAL_BULLETHOLE1 To DECAL_BULLETHOLE2
		DecalTextures[i] = LoadTexture_Strict("GFX\Decals\bullet_hole_"+(i-12)+".jpg", 1+2, 2)
	Next
	DecalTextures[DECAL_SLASHHOLE] = LoadTexture_Strict("GFX\Decals\slash_hole_1.jpg", 1+2, 2)
...
Function UpdateDecals()
	...
	For d.Decals = Each Decals
		...
		If d\lifetime > 0 Then
			d\lifetime=Max(d\lifetime-fps\Factor[0],5)
		EndIf
