		...
		If e\EventState[0] = 0.0
			If EntityDistanceSquared(e\room\Objects[0],Collider)<PowTwo(1.4) And e\EventState[2] = 0.0
				...
				If brokendoor
					...
					e\SoundCHN2 = PlaySound2(DoorSparksSFX,Camera,e\room\Objects[1],5)
				EndIf
		...
		Else
			If e\EventState[1] < 70*7
				...
				ElseIf e\EventState[1] > 70*3 And e\EventState[0] < 70*5.5
					...
					FreeEntity pvt
					If e\SoundCHN = 0 Then e\SoundCHN = PlaySound2(AirlockSFX[Rand(0,1)],Camera,e\room\Objects[0],5)
				EndIf
			Else
				e\EventState[0] = 0.0
				e\EventState[1] = 0.0
