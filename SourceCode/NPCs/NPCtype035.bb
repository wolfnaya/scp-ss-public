...
Function CreateNPCtype035MP(n.NPCs)
	...
	n\obj2 = LoadMesh_Strict("GFX\npcs\scps\035\mask_smile.b3d")
	n\obj3 = LoadMesh_Strict("GFX\npcs\scps\035\mask_sad.b3d")
	
	Local Tex1%,Tex2%,Tex3%
	...
	ScaleEntity(n\obj3, temp, temp, temp)
	
	If Tex1 Then
		n\texture = LoadTexture_Strict("GFX\npcs\scps\035\035.jpg", 0, 2)
	ElseIf Tex2 Then
		n\texture = LoadTexture_Strict("GFX\npcs\scps\035\035_2.jpg", 0, 2)
	ElseIf Tex3 Then
		n\texture = LoadTexture_Strict("GFX\npcs\scps\035\035_3.jpg", 0, 2)
	EndIf
	TextureBlend(n\texture,5)
	EntityTexture(n\obj, n\texture)
	EntityTexture(n\obj2, n\texture)
	EntityTexture(n\obj3, n\texture)
	
	PositionEntity(n\obj2, EntityX(n\obj), EntityY(n\obj) + 0.85, EntityZ(n\obj) - 0.095)
	EntityParent(n\obj2, FindChild(n\obj, "Bip01_Head"))
	PositionEntity(n\obj3, EntityX(n\obj), EntityY(n\obj) + 0.85, EntityZ(n\obj) - 0.095)
	EntityParent(n\obj3, FindChild(n\obj, "Bip01_Head"))
	ShowEntity n\obj2
	HideEntity n\obj3
...
Function CreateNPCtype035(n.NPCs)
	...
	n\obj = LoadAnimMesh_Strict("GFX\NPCs\Scps\035\035.b3d")
	n\obj2 = LoadMesh_Strict("GFX\npcs\scps\035\mask_smile.b3d")
	n\obj3 = LoadMesh_Strict("GFX\npcs\scps\035\mask_sad.b3d")
	...
	Else
		...
		If n\Frame >= dieFrame
			...
			Else
				...
				ElseIf n\State2 >= 1000 And n\State2 < 2000 Then
					EntityAlpha n\obj,Inverse((n\State2-1000.0)/1000.0)
					EntityAlpha n\obj3,Inverse((n\State2-1000.0)/1000.0)
					n\State2 = n\State2 + 2*fps\Factor[0]
				Else
					RemoveNPC(n)
					Return
