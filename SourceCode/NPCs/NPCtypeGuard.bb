...
Function CreateNPCtypeGuard(n.NPCs)
	...
	n\obj = LoadAnimMesh_Strict("GFX\npcs\Humans\Personnel\Guards\FacilityGuard.b3d")
...
Function CreateNPCTypeWoundedGuard(n.NPCs)
	Local temp#
	
	n\NPCName = "Wounded_Guard"
	n\NVName = "Human"
	n\Collider = CreatePivot()
	EntityRadius n\Collider, 0.2
	EntityType n\Collider, HIT_PLAYER
	n\obj = LoadAnimMesh_Strict("GFX\npcs\Humans\Personnel\Guards\Wounded_FacilityGuard.b3d")
...
Function UpdateNPCTypeWoundedGuard(n.NPCs)
