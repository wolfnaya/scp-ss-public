Include "SourceCode\Rooms\Area_035_NTF_Encounter.bb"
Include "SourceCode\Rooms\Area_076.bb"
Include "SourceCode\Rooms\Area_106_Escape.bb"
Include "SourceCode\Rooms\Area_1102_RU.bb"
Include "SourceCode\Rooms\Area_2935.bb"
Include "SourceCode\Rooms\Checkpoint.bb"
Include "SourceCode\Rooms\Checkpoint_ACZ.bb"
Include "SourceCode\Rooms\Core.bb"
Include "SourceCode\Rooms\Cont_005.bb"
Include "SourceCode\Rooms\Cont_008.bb"
Include "SourceCode\Rooms\Cont_016.bb"
Include "SourceCode\Rooms\Cont_049.bb"
Include "SourceCode\Rooms\Cont_059.bb"
Include "SourceCode\Rooms\Cont_079.bb"
Include "SourceCode\Rooms\Cont_106.bb"
Include "SourceCode\Rooms\Cont_109_198_357_402_447.bb"
Include "SourceCode\Rooms\Cont_173.bb"
Include "SourceCode\Rooms\Cont_207_268_1079_1033RU.bb"
Include "SourceCode\Rooms\Cont_409.bb"
...
Include "SourceCode\Rooms\Gate_A_Road.bb"
Include "SourceCode\Rooms\Gate_B_Entrance.bb"
Include "SourceCode\Rooms\Gate_B_Topside.bb"
Include "SourceCode\Rooms\Gate_C_Entrance.bb"
Include "SourceCode\Rooms\Gate_C_Topside.bb"
Include "SourceCode\Rooms\Gate_D_Entrance.bb"
Include "SourceCode\Rooms\Lockroom_1.bb"
Include "SourceCode\Rooms\Lockroom_2.bb"
Include "SourceCode\Rooms\Lockroom_3.bb"
Include "SourceCode\Rooms\Personnel_Offices.bb"
Include "SourceCode\Rooms\Pocketdimension.bb"
Include "SourceCode\Rooms\Room1_Intro.bb"
Include "SourceCode\Rooms\Room1_Start.bb"
Include "SourceCode\Rooms\Room1_Sewers.bb"
Include "SourceCode\Rooms\Room1_Sws.bb"
Include "SourceCode\Rooms\Room1_O5.bb"
...
Include "SourceCode\Rooms\Room2_BCZ.bb"
Include "SourceCode\Rooms\Room2_2_BCZ.bb"
Include "SourceCode\Rooms\Room2_3_BCZ.bb"
Include "SourceCode\Rooms\room1_sky_office.bb"
Include "SourceCode\Rooms\Room2_Closets.bb"
Include "SourceCode\Rooms\Room2_Doors.bb"
Include "SourceCode\Rooms\Room2_EZ_1.bb"
Include "SourceCode\Rooms\Room2_Generators_LCZ.bb"
Include "SourceCode\Rooms\Room2_GW.bb"
Include "SourceCode\Rooms\Room2_Info.bb"
Include "SourceCode\Rooms\Room2_Lws.bb"
Include "SourceCode\Rooms\Room2_Ws.bb"
...
Include "SourceCode\Rooms\Room2_Offices_BCZ.bb"
Include "SourceCode\Rooms\Room2_Pipes_1.bb"
Include "SourceCode\Rooms\Room2_Pipes_2.bb"
Include "SourceCode\Rooms\Room2_Pit.bb"
Include "SourceCode\Rooms\Room2_Rocky.bb"
Include "SourceCode\Rooms\Facility_Reactor.bb"
...
Include "SourceCode\Rooms\Room2_Ventilation.bb"
Include "SourceCode\Rooms\Room2C_EZ.bb"
Include "SourceCode\Rooms\Room2C_Office_EZ.bb"
Include "SourceCode\Rooms\Room2C_Ews.bb"
Include "SourceCode\Rooms\Room2C_Pit.bb"
Include "SourceCode\Rooms\room2c_research.bb"
Include "SourceCode\Rooms\Room3_BCZ.bb"
Include "SourceCode\Rooms\Room3_EZ.bb"
Include "SourceCode\Rooms\Room3_GW.bb"
Include "SourceCode\Rooms\Room3_CT.bb"
Include "SourceCode\Rooms\Room3_HCZ.bb"
Include "SourceCode\Rooms\Room2C_Hws.bb"
Include "SourceCode\Rooms\Room2C_BCZ.bb"
Include "SourceCode\Rooms\Room3_Info.bb"
Include "SourceCode\Rooms\Room3_Pit.bb"
Include "SourceCode\Rooms\Room3_Tunnel_1.bb"
Include "SourceCode\Rooms\Room3_Tunnel_2.bb"
Include "SourceCode\Rooms\Room4_Circle_Tree.bb"
Include "SourceCode\Rooms\Room4_EZ.bb"
Include "SourceCode\Rooms\Room4_Ventilation.bb"
...
Const GATE_A_ROAD% = 7
Const GATE_A_TOPSIDE% = 8
Const GATE_B_TOPSIDE% = 9
Const GATE_C_TOPSIDE% = 10
Const AREA_076% = 11
Const AREA_106_ESCAPE% = 12
...
Function IsPlayerOutside()
	...
	If gc\CurrGamemode = 3 Then Return False
...
Function LoadRMesh(file$,rt.RoomTemplates, doublesided=True)
	...
	Local range#,lcolor$,intensity#,r%,g%,b%,angles$,pitch#,innercone%,outercone%,room.Rooms
	...
	For i%=1 To count
		...
		Select temp1s
			Case "screen"
				...
				If gc\CurrGamemode<>3 And (Not MainMenuOpen) Then
			...
			Case "waypoint"
				...
				If (Not MainMenuOpen) And gc\CurrGamemode<>3 Then
			...
			Case "light"
				...
				If temp1<>0 Lor temp2<>0 Lor temp3<>0 Then 
					...
					ElseIf (Not MainMenuOpen) And gc\CurrGamemode=3 Then
...
Function LoadRoomTemplates(file$)
	...
	While Not Eof(f)
		If drawtimer >= 5 Then
			DrawLoading(-1,True, "", GetLocalString("Loading","room_templates"))
			drawtimer = 0
		Else
	...
	Repeat
		If drawtimer >= 5 Then
			DrawLoading(-1,True, "", GetLocalString("Loading","room_ambience"))
			drawtimer = 0
		Else
			drawtimer = drawtimer + 1
		EndIf
...
Function FillRoom(r.Rooms)
	...
	Select r\RoomTemplate\Name
		...
		Case "room2_generators_lcz"
			FillRoom_Room2_Generators_LCZ(r)
		...
		Case "room4_circle_tree"
			FillRoom_Room4_Circle_Tree(r)
		Case "room4_ez"
			FillRoom_Room4_EZ(r)
		Case "room2_info"
		...
		If s\room = PlayerRoom Then
			If EntityDistanceSquared(Collider,s\obj)<PowTwo(1.2) Then
				...
				If PickedEntity()=s\obj And s\imgpath<>"" Then
					...
					If KeyHitUse
						SelectedScreen=s
						s\img = LoadImage_Strict("GFX\Map\Textures\screens\"+s\imgpath)
...
Function UpdateSecurityCams()
	...
	For sc.SecurityCams = Each SecurityCams
		...
		Else
			...
			If sc\room <> Null
				If sc\room\RoomTemplate\Name = "surveil_room" Then sc\CoffinEffect = 0
			EndIf
				...
				If sc\Screen Then
					...
					If BlinkTimer > -5.0 And EntityInView(sc\ScrObj, Camera) Then
						If EntityVisible(Camera, sc\ScrObj) Then
							If (sc\CoffinEffect = 1 Lor sc\CoffinEffect = 3) And (Not I_714\Using) And wbi\Hazmat <> 3 And wbi\GasMask <> 3 Then
								If BlinkTimer > -5.0 Then
									Sanity = Sanity - fps\Factor[0]
									RestoreSanity = False
								EndIf
							EndIf
						EndIf
					...
					If (sc\CoffinEffect = 1 Lor sc\CoffinEffect = 3) And (Not I_714\Using) And wbi\Hazmat <> 3 And wbi\GasMask <> 3 Then
						If sc\InSight Then
							...
							FreeEntity(Pvt)
							If (sc\CoffinEffect = 1 Lor sc\CoffinEffect = 3) And ((Not I_714\Using) And wbi\GasMask <> 3 And wbi\Hazmat <> 3) Then
...
Function FindPlayerFloor%()
	Local PlayerY# = Floor(EntityY(Collider))
...
Function FindFloor%(e.Events)
	Select e\EventName
		Case "cont_106", "cont_008", "cont_049", "room1_start"
			;[Block]
			Return(LowerFloor)
			;[End Block]
		Case "room2_nuke"
...
Function UpdateElevators#(State#, door1.Doors, door2.Doors, room1, room2, event.Events, ignorerotation% = True)
	...
	If door1\open Then
		...
		If Abs(EntityX(Collider)-EntityX(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
			If Abs(EntityZ(Collider)-EntityZ(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then	
				If Abs(EntityY(Collider)-EntityY(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then	
					door1\locked = False
					door1\IsElevatorDoor = 1
				EndIf
			EndIf
	...
	If door2\open Then
		...
		If Abs(EntityX(Collider)-EntityX(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
			If Abs(EntityZ(Collider)-EntityZ(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then	
				If Abs(EntityY(Collider)-EntityY(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
					door2\locked = False
					door2\IsElevatorDoor = 1
				EndIf
			EndIf
			...
			If State < 0 Then
				...
				If State < -500 Then
					...
					If inside Then
						...
						TeleportEntity(Collider, EntityX(room2,True)+x,(0.1*fps\Factor[0])+EntityY(room2,True)+(EntityY(Collider)-EntityY(room1,True)),EntityZ(room2,True)+z,0.3,True)
					...
					For n.NPCs = Each NPCs
						If Abs(EntityX(n\Collider)-EntityX(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
							If Abs(EntityZ(n\Collider)-EntityZ(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
								If Abs(EntityY(n\Collider)-EntityY(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
									If (Not ignorerotation) Then
									...
									TeleportEntity(n\Collider, EntityX(room2,True)+x,(0.1*fps\Factor[0])+EntityY(room2,True)+(EntityY(n\Collider)-EntityY(room1,True)),EntityZ(room2,True)+z,n\CollRadius,True)
									If n = Curr173 Then
					...
					For it.Items = Each Items
						If Abs(EntityX(it\Collider)-EntityX(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
							If Abs(EntityZ(it\Collider)-EntityZ(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
								If Abs(EntityY(it\Collider)-EntityY(room1,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
									If (Not ignorerotation) Then
									...
									TeleportEntity(it\Collider, EntityX(room2,True)+x,(0.1*fps\Factor[0])+EntityY(room2,True)+(EntityY(it\Collider)-EntityY(room1,True)),EntityZ(room2,True)+z,0.01,True)
								EndIf
							EndIf
						EndIf
					Next
			...
			Else
				...
				If State > 500 Then 
					...
					If inside Then	
						...
						TeleportEntity(Collider, EntityX(room1,True)+x,(0.1*fps\Factor[0])+EntityY(room1,True)+(EntityY(Collider)-EntityY(room2,True)),EntityZ(room1,True)+z,0.3,True)
						d_I\UpdateDoorsTimer = 0
						DropSpeed = 0
						UpdateDoors()
						UpdateRooms()
					...
					For n.NPCs = Each NPCs
						If Abs(EntityX(n\Collider)-EntityX(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
							If Abs(EntityZ(n\Collider)-EntityZ(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
								If Abs(EntityY(n\Collider)-EntityY(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
									If (Not ignorerotation) Then
									...
									TeleportEntity(n\Collider, EntityX(room1,True)+x,(0.1*fps\Factor[0])+EntityY(room1,True)+(EntityY(n\Collider)-EntityY(room2,True)),EntityZ(room1,True)+z,n\CollRadius,True)
									If n = Curr173 Then
										Curr173\IdleTimer = 10
									EndIf
								EndIf
					...
					Next
					For it.Items = Each Items
						If Abs(EntityX(it\Collider)-EntityX(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
							If Abs(EntityZ(it\Collider)-EntityZ(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
								If Abs(EntityY(it\Collider)-EntityY(room2,True))<280.0*RoomScale+(0.015*fps\Factor[0]) Then
									If (Not ignorerotation) Then
									...
									TeleportEntity(it\Collider, EntityX(room1,True)+x,(0.1*fps\Factor[0])+EntityY(room1,True)+(EntityY(it\Collider)-EntityY(room2,True)),EntityZ(room1,True)+z,0.01,True)
								EndIf
							EndIf
						EndIf
					Next
...
Function CreateMap()
	...
	If gc\CurrZone > GATE_A_INTRO And gc\CurrZone < REACTOR_AREA Then
		...
		Select gc\CurrZone
			...
			Case LCZ
				...
				If opt\IntroEnabled Then
					If clm\DMode Then
;						r = CreateRoom(0, ROOM1, (MapGridSize+20) * spacing, 0, (MapGridSize+20) * spacing, "classd_cells")
;						TurnEntity(r\obj, 0, r\angle, 0)
					Else
							...
							Else
								...
								If r\LightConeSpark[i]<>0 Then
									If r\LightConeSparkTimer[i]>0 And r\LightConeSparkTimer[i]<10 Then
										...
										r\LightConeSparkTimer[i]=r\LightConeSparkTimer[i]+fps\Factor[0]
									Else
										HideEntity r\LightConeSpark[i]
								...
								If r\LightCone[i]<>0 Then
									...
									If r\LightFlicker%[i]>4 Then
										If Rand(400)=1 Then
											...
											ShowEntity r\LightConeSpark[i]
											r\LightConeSparkTimer[i] = fps\Factor[0]
										EndIf
									EndIf
								EndIf
							EndIf
...
Function ValidRoom2slCamRoom(r.Rooms)
	...
	If RN$ = "room2_closets" Then Return True
	If RN$ = "room1_archive" Then Return True
	If RN$ = "room3_ez" Then Return True
	If RN$ = "room1_elevators" Then Return True
	If RN$ = "core_lcz" Then Return True
	If RN$ = "room2_nuke" Then Return True
	If RN$ = "cont_008" Then Return True
	If RN$ = "cont_1162" Then Return True
	If RN$ = "cont_966" Then Return True
	If RN$ = "room2c_cont" Then Return True
...
Function PreventRoomOverlap(r.Rooms)
	...
	;If r\RoomTemplate\Name = "core_ez" Lor r\RoomTemplate\Name = "core_lcz" Lor r\RoomTemplate\Name = "core_ez" Then Return True
...
Function CreateFluLight.FluLight(id%)
	...
	Local tex = LoadTexture_Strict("GFX\Particles\particle_2.png",1+2)
			...
			Select fll\state
				...
				Case FLU_STATE_FLICKER
					...
					Else
						...
						ShowEntity fll\lightobj
						EntityTexture fll\obj,fll\tex[FluState_On]
						fll\time = Min(fll\time + fps\Factor[0],0.0)
					EndIf
			End Select
		Else
			HideEntity fll\obj
