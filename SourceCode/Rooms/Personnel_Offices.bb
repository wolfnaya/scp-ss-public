...
Function FillRoom_Personnel_Offices(r.Rooms)
	...
	; ~ [Wolfnaya's Door #2]
	r\RoomDoors[1] = CreateDoor(r\zone, r\x+1424* RoomScale, r\y +384.0 * RoomScale, r\z +723 * RoomScale, 90, r, True, DOOR_DEFAULT, False, "2109")
	...
	it = CreateItem("Benjamin Oliver's Badge", "badge", r\x +1632.0 * RoomScale, r\y +510.0 * RoomScale, r\z -267.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	
	it = CreateItem("Level 4 key Card", "key4", r\x +1632.0 * RoomScale, r\y +510.0 * RoomScale, r\z -267.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	...
	it = CreateItem("V Coin", "vanecoin", r\x +1998.0 * RoomScale, r\y +881.0 * RoomScale, r\z + 2486.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	
	it = CreateItem("Monitoring Unit", "mui", r\x -2410.0 * RoomScale, r\y +600.0 * RoomScale, r\z + 610.0 * RoomScale)
	EntityParent(it\collider, r\obj)
