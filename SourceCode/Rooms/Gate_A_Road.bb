...
Function FillRoom_Gate_A_Road(r.Rooms)
	...
	it = CreateItem("AK-12","ak12", r\x-30.0*RoomScale,1, r\z-2230.0*RoomScale)
	it\state = 30 : it\state2 = 120
	EntityParent(it\collider, r\obj)
	it = CreateItem("H&K MP5K", "mp5k", r\x-30.0*RoomScale, 1, r\z-2230.0*RoomScale)
	it\state = 30 : it\state2 = 90
	EntityParent(it\collider, r\obj)
	it = CreateItem("FN P90","p90", r\x-30.0*RoomScale, 1, r\z-2230.0*RoomScale)
	it\state = 50 : it\state2 = 150
	EntityParent(it\collider, r\obj)
	
	it = CreateItem("Franchi SPAS-12","spas12", r\x+255.0*RoomScale, 1, r\z-26.0*RoomScale)
	it\state = 6 : it\state2 = 56
	EntityParent(it\collider, r\obj)
	it = CreateItem("M61 Grenade","grenade", r\x+255.0*RoomScale,1, r\z-26.0*RoomScale)
	EntityParent(it\collider, r\obj)
	...
	If PlayerRoom = e\room Then
		...
		If e\EventState[2] = 0 Then
			If opt\MusicVol > 0 Then
				e\Sound = LoadSound_Strict("SFX\Music\Chase_Music\Cyber_Chase_2.ogg")
		...
		If e\EventState[0] = 0 Then
			...
			ItemAmount = ItemAmount + 1
				;USP
			it = CreateItem("AK-12", "ak12", 1, 1, 1)
			it\Picked = True
			it\Dropped = -1
			it\itemtemplate\found=True
			Inventory[1] = it
			...
			g_I\Weapon_InSlot[GunSlot2] = "ak12"
			g_I\Weapon_InSlot[GunSlot3] = "hk416"
...
; ~ Actual Ending Event
		...
		If e\EventState[0] > 70*65.0 And e\EventState[0] < 70*65.025 Then
			CreateSplashText(GetLocalString("Singleplayer","fight"),opt\GraphicWidth/2,opt\GraphicHeight/2,50,2,Font_Default_Medium,True,False,255,0,0)
			g_I\HoldingGun = 14
		EndIf
		...
		If e\EventState[2] > 0 Then
			...
			If ChannelPlaying(e\SoundCHN) Then
				...
				If opt\MusicVol > 0 Then
					e\SoundCHN2 = PlaySound_Strict(LoadTempSound("SFX\Music\Chase_Music\Cyber_Chase_2_Ending.ogg"))
