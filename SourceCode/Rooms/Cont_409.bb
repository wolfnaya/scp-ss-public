Function FillRoom_Cont_409(r.Rooms)
	...
	it.Items = CreateItem("Document SCP-409", "paper", r\x + 74.0 * RoomScale, r\y - 2469.0 * RoomScale, r\z + 5518.0 * RoomScale)
	RotateEntity(it\collider, 0.0, 0.0, 0.0)
	EntityParent(it\collider, r\obj)
	
	it.Items = CreateItem("Infected SCP-409 Document", "paper", r\x - 340.0 * RoomScale, r\y - 2582.0 * RoomScale, r\z + 3750.0 * RoomScale)
	RotateEntity(it\collider, 0.0, 0.0, 0.0)
	EntityParent(it\collider, r\obj)
	...
	If PlayerRoom = e\room Then
		...
		If e\EventState[0] = 0.0 Then
			...
			If e\room\NPC[0] = Null Then
				e\room\NPC[0] = CreateNPC(NPCTypeElias,EntityX(e\room\Objects[1],True),EntityY(e\room\Objects[1],True),EntityZ(e\room\Objects[1],True))
