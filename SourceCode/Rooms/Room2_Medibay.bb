...
Function FillRoom_Room2_Medibay(r.Rooms)
	...
	tex = LoadTexture_Strict("GFX\Npcs\SCPs\Anomalous Ducks\duck4.png")
	TextureBlend(tex, 5)
...
Function UpdateEvent_Room2_Medibay(e.Events)
	If PlayerRoom = e\room Then
		...
		If e\EventState[0] = 0.0 Then
			e\room\NPC[0] = CreateNPC(NPCtype008, EntityX(e\room\Objects[0], True), 0.5, EntityZ(e\room\Objects[0], True))
