...
Function FillRoom_Room1_Sky_Office(r.Rooms)
	...
	it = CreateItem("cup", "cup", r\x-1124.0*RoomScale,r\y+1399*RoomScale,r\z-1426.0*RoomScale, 240,175,70)
	EntityParent(it\collider, r\obj) : it\name = "Cup of Orange Juice"
	
	it = CreateItem("cup", "cup", r\x-887*RoomScale,r\y+1366*RoomScale,r\z-2709.0*RoomScale, 87,62,45)
	EntityParent(it\collider, r\obj) : it\name = "Cup of Coffee"
	
	it = CreateItem("Empty Cup", "emptycup", r\x-108*RoomScale, r\y+161*RoomScale, r\z-343.0*RoomScale)
	EntityParent(it\collider, r\obj)
	
	it = CreateItem("Quarter", "25ct", r\x-1600.0*RoomScale,r\y+1406.0*RoomScale,r\z-1468.0*RoomScale)
	EntityParent(it\collider, r\obj)
	it = CreateItem("Quarter", "25ct", r\x-1600.0*RoomScale,r\y+1406.0*RoomScale,r\z-1468.0*RoomScale)
	EntityParent(it\collider, r\obj)
	...
	If PlayerRoom = e\room Then
		...
		If e\EventState[0] = 1 Then
			If e\room\RoomDoors[2]\open Then
				If Rand(2) = 1 Then
					e\SoundCHN = PlaySound2(LoadTempSound("SFX\Door\DoorSparks.ogg"),Camera,e\room\RoomDoors[2]\frameobj,10,2.5)
				Else
					e\SoundCHN = PlaySound2(LoadTempSound("SFX\General\Spark_medium.ogg"),Camera,e\room\RoomDoors[2]\frameobj,10,2.5)
				EndIf
				StopChannel(e\room\RoomDoors[2]\SoundCHN)
				e\EventState[0] = 2
			EndIf
		ElseIf e\EventState[0] = 2 Then
			UpdateSoundOrigin(e\SoundCHN,Camera,e\room\RoomDoors[2]\frameobj,10,2.5)
