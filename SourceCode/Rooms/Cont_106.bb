...
Function UpdateEvent_Cont_106(e.Events)
	...
	If SoundTransmission Then 
		If e\EventState[0] = 1 Then
			e\EventState[2] = Min(e\EventState[2]+fps\Factor[0],4000)
		EndIf
	...
	If PlayerRoom = e\room And e\room\NPC[0]<>Null Then
		...
		ElseIf e\EventState[0] = 1 ;bone broken
			...
			If e\EventState[2] => 2500 Then
				...
				If e\EventState[1] = 1 And e\EventState[2]-fps\Factor[0] < 2500 Then
				...
				If e\EventState[2]-fps\Factor[0] < 2500 Then 
					...
					e\SoundCHN2=PlaySound_Strict(e\Sound2)
				ElseIf e\EventState[2]-fps\Factor[0] < 2900 And e\EventState[2] => 2900 Then
				...
				ElseIf e\EventState[2] > 3200 Then
					...
					If e\EventState[1] = True Then ;magnets off -> 106 caught
						Contained106 = True
