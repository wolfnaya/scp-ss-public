...
Function FillRoom_Room2_Maintenance(r.Rooms)
	...
	d.Doors = CreateDoor(r\zone, r\x+279*RoomScale,r\y,r\z-480*RoomScale,90, r, False, DOOR_OFFICE_2)
	
	it = CreateItem("Yellow Severed Hand", "hand3", r\x + 1920.0 * RoomScale, r\y-5596 * RoomScale, r\z+2301.0* RoomScale)
