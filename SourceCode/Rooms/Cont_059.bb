...
Function FillRoom_Cont_059(r.Rooms)
	...
	it = CreateItem("Level 3 Key Card", "key3", r\x -96.0 * RoomScale, r\y-656 * RoomScale, r\z-160.0* RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("Black Severed Hand", "hand2", r\x -96.0 * RoomScale, r\y-656 * RoomScale, r\z-160.0* RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("SCP-059 Sample", "scp059", r\x -32.0 * RoomScale, r\y-656 * RoomScale, r\z-650.0* RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("Radio Transceiver", "radio", r\x -192.0 * RoomScale, -656.0* RoomScale, r\z+96.0* RoomScale, True)
	EntityParent(it\Collider, r\obj)
