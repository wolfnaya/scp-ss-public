...
Function FillRoom_Gate_A_Topside(r.Rooms)
	...
	d2 = CreateDoor(r\zone, r\x-1440*RoomScale, (12000.0-480.0)*RoomScale, r\z + 2328.0 * RoomScale, 0, r, False, False, KEY_CARD_2)
	...
	d2 = CreateDoor(r\zone, r\x-1440*RoomScale, (12000.0-480.0)*RoomScale, r\z + 4352.0 * RoomScale, 0, r, False, False, KEY_CARD_2)
	If SelectedEnding = "A2" Then 
		d2\AutoClose = False : d2\open = True : d2\locked = True	
	Else
		d2\AutoClose = False : d2\open = False : d2\locked = False
...
Function UpdateEvent_Gate_A_Topside(e.Events)
	...
	If PlayerRoom = e\room Then 
		...
		If e\EventState = 0 Then
			...
			Sky = sky_CreateSky("GFX\map\sky\sky_day_day")
