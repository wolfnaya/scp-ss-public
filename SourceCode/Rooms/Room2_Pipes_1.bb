...
Function UpdateEvent_Room2_Pipes_1(e.Events)
	...
	If (Not Contained106) Then 
		...
		Else
			e\EventState[0]=(e\EventState[0]+fps\Factor[0]*0.7)
			...
			If (e\EventState[0] / 250.0) > 0.3 And ((e\EventState[0] - fps\Factor[0]*0.7) / 250.0) <= 0.3 Then
			...
			If (e\EventState[0] / 250.0) > 0.65 And ((e\EventState[0] - fps\Factor[0]*0.7) / 250.0) <= 0.65 Then
