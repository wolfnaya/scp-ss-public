		...
		Else
			...
			If e\EventState[1] = 0 Then
				...
				If ChannelPlaying(e\SoundCHN)=False Then
					e\SoundCHN = PlaySound_Strict(LoadTempSound("SFX\General\Rain.ogg"))
				EndIf
				
				If EntityDistanceSquared(Collider,e\room\Objects[1])<PowTwo(1.5) Then
					PlayAnnouncement("SFX\Character\MTF\AnnouncExposure.ogg")
					e\EventState[1] = 1
			...
			If e\EventState[1] = 1 Then
				...
				If ChannelPlaying(e\SoundCHN2)=False Then
					e\SoundCHN2 = PlaySound_Strict(LoadTempSound("SFX\General\Rain_2.ogg"))
				EndIf
				
				If e\room\NPC[0] = Null Then
					e\room\NPC[0] = CreateNPC(NPCtype682,EntityX(e\room\Objects[4],True),EntityY(e\room\Objects[4],True),EntityZ(e\room\Objects[4],True))
				...
				If EntityDistanceSquared(Collider,e\room\Objects[0])<PowTwo(2) Then
					e\SoundCHN = LoopSound2(TruckSFX, e\SoundCHN, Camera, e\room\Objects[0], 10.0, 1)
					DrawHandIcon = True
					If KeyHitUse Then
						e\EventState[1] = 2
					EndIf
			...
			If e\EventState[1] = 2 Then
				e\EventState[2] = e\EventState[2] + (fps\Factor[0]*0.01)
