Function FillRoom_Room2_Lws(r.Rooms)
	...
	it = CreateItem("Red Dot Sight", "reddot", r\x -619.0 * RoomScale, r\y +140.0 * RoomScale, r\z +427.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("Suppressor", "suppressor", r\x -617.0 * RoomScale, r\y +210.0 * RoomScale, r\z +432.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("MP5 Folding Stock", "mp5stock2", r\x -583.0 * RoomScale, r\y +126.0 * RoomScale, r\z -411.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("AimPoint Sight", "aimpoint", r\x +866.0 * RoomScale, r\y +140.0 * RoomScale, r\z +405.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("Scope Battery", "scopebat", r\x +866.0 * RoomScale, r\y +140.0 * RoomScale, r\z +405.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
