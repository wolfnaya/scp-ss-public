Function FillRoom_Room2C_Hws(r.Rooms)
	...
	it = CreateItem("H&K MP5K", "mp5k", r\x +665.0 * RoomScale, r\y +200.0 * RoomScale, r\z +309.0 * RoomScale)
	...
	it = CreateItem("H&K 416", "hk416", r\x -788.0 * RoomScale, r\y +250.0 * RoomScale, r\z -959.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	RotateEntity it\Collider,90,0,0
	it\state2 = 60 : it\state = 30
	
	it = CreateItem("Acog Scope", "acog", r\x -569.0 * RoomScale, r\y +125.0 * RoomScale, r\z -371.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	...
	it = CreateItem("Document SCP-127", "paper", r\x +714.0 * RoomScale, r\y +55.0 * RoomScale, r\z -630.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("Ammo Crate", "ammocrate", r\x+255.0*RoomScale, r\y+10.0*RoomScale, r\z+786.0*RoomScale)
	EntityParent(it\Collider, r\obj)
	it = CreateItem("Ammo Crate", "ammocrate", r\x+255.0*RoomScale, r\y+10.0*RoomScale, r\z+786.0*RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it = CreateItem("Big Ammo Crate", "bigammocrate", r\x-918.0*RoomScale, r\y+10.0*RoomScale, r\z-366.0*RoomScale)
	EntityParent(it\Collider, r\obj)
	it = CreateItem("Ammo Crate", "ammocrate", r\x-918.0*RoomScale, r\y+10.0*RoomScale, r\z-366.0*RoomScale)
	EntityParent(it\Collider, r\obj)
	it = CreateItem("Ammo Crate", "ammocrate", r\x-918.0*RoomScale, r\y+10.0*RoomScale, r\z-366.0*RoomScale)
	EntityParent(it\Collider, r\obj)
