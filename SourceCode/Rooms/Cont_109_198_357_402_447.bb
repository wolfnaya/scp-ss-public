Function FillRoom_Cont_109_198_357_402_447(r.Rooms)
	...
	it.Items = CreateItem("Document SCP-447", "paper", r\x + 754.0 * RoomScale, r\y + 10.0 * RoomScale, r\z -677.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
	
	it.Items = CreateItem("Document SCP-109", "paper", r\x +1209.0 * RoomScale, r\y + 10.0 * RoomScale, r\z - 158.0 * RoomScale)
	RotateEntity(it\Collider, 0.0, r\angle, 0.0)
	EntityParent(it\Collider, r\obj)
	
	it.Items = CreateItem("Document SCP-198", "paper", r\x + 1245.0 * RoomScale, r\y + 160.0 * RoomScale, r\z + 919.0 * RoomScale)
	RotateEntity(it\Collider, 0.0, r\angle, 0.0)
	EntityParent(it\Collider, r\obj)
	
	it.Items = CreateItem("Document SCP-357", "paper", r\x -416.0 * RoomScale, r\y + 10.0 * RoomScale, r\z + 721.0 * RoomScale)
	RotateEntity(it\Collider, 0.0, r\angle, 0.0)
	EntityParent(it\Collider, r\obj)
	
	it.Items = CreateItem("Document SCP-402", "paper", r\x - 445.0 * RoomScale, r\y + 105.0 * RoomScale, r\z - 902.0 * RoomScale)
	RotateEntity(it\Collider, 0.0, r\angle, 0.0)
	EntityParent(it\Collider, r\obj)
	
End Function

Function UpdateEvent_Cont_109_198_357_402_447(e.Events)
