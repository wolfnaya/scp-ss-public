...
Function FillRoom_Checkpoint_ACZ(r.Rooms)
	...
	r\RoomDoors[1] = CreateDoor(r\zone,r\x,r\y,r\z - 400.0*RoomScale,180,r,True,DOOR_WINDOWED_2,False,"1234")
	r\RoomDoors[2] = CreateDoor(r\zone,r\x,r\y,r\z + 400.0*RoomScale,0,r,False,DOOR_WINDOWED_2,False,"1234")
	For i = 0 To 1
	...
	r\RoomDoors[6] = CreateDoor(r\zone,r\x+1265*RoomScale,r\y,r\z+912.0*RoomScale,270,r,False,DOOR_OFFICE_2)
	...
	it = CreateItem("SCRAMBLE Gear", "scramble",r\x-26*RoomScale,1.0,r\z+806*RoomScale)
	it\state = 1000
	EntityParent it\collider, r\obj
		...
		If e\room\dist < 6.0 Then
			If e\room\RoomDoors[1]\locked = True Then
				If (Not e\SoundCHN) Then
					e\SoundCHN = PlaySound_Strict(AlarmSFX[6])
				Else
					If (Not ChannelPlaying(e\SoundCHN)) Then e\SoundCHN = PlaySound_Strict(AlarmSFX[6])
				EndIf
			EndIf
		EndIf
	EndIf
