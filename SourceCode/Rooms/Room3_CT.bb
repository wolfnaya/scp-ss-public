...
Function FillRoom_Room3_CT(r.Rooms)
	...
	it = CreateItem("Fuse", "fuse", r\x + 733.0 * RoomScale, r\y - 3970.0 * RoomScale, r\z +1968.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x -4376.0 * RoomScale, r\y - 4066.0 * RoomScale, r\z +1112.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x -1164.0 * RoomScale, r\y - 2614.0 * RoomScale, r\z +2990.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x -496.0 * RoomScale, r\y +140.0 * RoomScale, r\z +700.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x +1144.0 * RoomScale, r\y-4029.0 * RoomScale, r\z +13.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x +5804.0 * RoomScale, r\y-3959.0 * RoomScale, r\z +5852.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	; ~ Alt fuses (If player won't find all of them)
	
	it = CreateItem("Fuse", "fuse", r\x -1416.0 * RoomScale, r\y -7460.0 * RoomScale, r\z +4574.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x +4708.0 * RoomScale, r\y-3915.0 * RoomScale, r\z +3737.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x +993.0 * RoomScale, r\y-7456.0 * RoomScale, r\z +10.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("Fuse", "fuse", r\x -1367.0 * RoomScale, r\y-7456.0 * RoomScale, r\z -10.0 * RoomScale)
	EntityParent(it\collider, r\obj)
	EntityType it\collider, HIT_ITEM
	
	it = CreateItem("H&K P30L", "p30l", r\x -5239.0 * RoomScale, r\y-4055.0 * RoomScale, r\z -29.0 * RoomScale)
...
Function UpdateEvent_Room3_CT(e.Events)
	...
	If (Not clm\GlobalMode) Then
		...
		If PlayerRoom = e\room
			...
			If ecst\FusesAmount = 4 Then
				If d_I\ClosestButton = e\room\Objects[13] And KeyHitUse Then
					...
					If e\room\NPC[0] = Null And Curr106\Idle = False Then
						CreateNPC(NPCtype106,EntityX(e\room\Objects[13]),EntityY(e\room\Objects[13]),EntityZ(e\room\Objects[13]))
					EndIf
				EndIf
			...
			If EntityY(Collider)<-6000.0*RoomScale ;Level 1
