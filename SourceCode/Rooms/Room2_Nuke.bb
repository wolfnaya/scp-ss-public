...
;	em\Gravity = -0.05
	...
	it = CreateItem("S&W Model 500", "sw500",r\x+1067*RoomScale,1.0,r\z-142*RoomScale)
	it\state = 4 : it\state2 = 45
	EntityParent it\collider, r\obj
	
	it = CreateItem("SCRAMBLE Gear", "scramble",r\x+1077*RoomScale,1.0,r\z-70*RoomScale)
	EntityParent it\collider, r\obj
...
Function UpdateEvent_Room2_Nuke(e.Events)
	...
	If e\EventState[2] = 0 Then
		...
		SetNPCFrame(n,555)
		n\IsDead = True
		n\texture = "GFX\npcs\Humans\Personnel\body2.jpg"
