...
Function FillRoom_Testroom_2B(r.Rooms)
	...
	it = CreateItem("Level 2 Key Card", "key2", r\x - 834.0 * RoomScale, r\y + 137.0 * RoomScale, r\z + 61.0 * RoomScale)
	...
	it = CreateItem("Surveillance Room Password Note", "paper", r\x, r\y + 96.0 * RoomScale, r\z + 640.0 * RoomScale)
	EntityParent(it\Collider, r\obj)
