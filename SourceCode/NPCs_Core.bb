...
Const NPCtype372% = 6, NPCtypeApache% = 7, NPCtypeNTF% = 8, NPCtype096 = 9
Const NPCtype049% = 10, NPCtype049_2% = 11, NPCtype5131% = 12, NPCtypeTentacle% = 13
Const NPCtype860% = 14, NPCtype939% = 15, NPCtype066% = 16, NPCtype178% = 17, NPCtypePdPlane% = 18
Const NPCtype966% = 19, NPCtype1048a = 20, NPCtype008% = 21, NPCtypeClerk% = 22

Const NPCtypeD2% = 23, NPCtype076% = 24
Const NPCtypeD9341 = 25

Const NPCType049_2MP% = 26
Const NPCtypeGuardZombieMP% = 27
Const NPCtype035% = 28
Const NPCtype682% = 29
Const NPCtype457% = 30
Const NPCtypeCI% = 31
Const NPCtype049_3% = 33, NPCtype049_4% = 34, NPCtype049_5% = 35, NPCtype008_2% = 36, NPCtype008_3% = 37, NPCType049_Guard% = 38, NPCType049_6% = 39
Const NPCtype008_4% = 40, NPCType963_2% = 41, NPCTypeWoundedGuard% = 42, NPCTypePlotNTF% = 43, NPCTypeNTFEnemy% = 44, NPCTypeFriendlyCI% = 45, NPCTypeJanitor% = 46
Const NPCTypeElias% = 47
Const NPCTypeCITest% = 48, NPCtype008_5% = 49
...
Include "SourceCode\NPCs\NPCtypeNTF.bb"
...
Include "SourceCode\NPCs\NPCtypeD9341.bb"
...
Function AnimateNPC(n.NPCs, start#, quit#, speed#, loop=True)
	...
	If speed > 0.0 Then 
		...
		newTime = Max(Min(n\Frame + speed * fps\Factor[0],quit),start)
	...
	Else
		...
		Else
			...
			newTime = Max(Min(n\Frame + speed * fps\Factor[0],start),quit)
		EndIf
	EndIf
...
Function CreateNPC.NPCs(NPCtype%, x#, y#, z#, model%=-1)
	...
	Select NPCtype
		...
		Case NPCTypeWoundedGuard
			CreateNPCTypeWoundedGuard(n)
		Case NPCtypeNTF, NPCTypePlotNTF, NPCTypeNTFEnemy
			CreateNPCtypeNTF(n)
		Case NPCtypeCI
			CreateNPCtypeCI(n)
		Case NPCTypeCITest
			createnpctypecitest(n)
		Case NPCtypeD9341
			CreateNPCtypeD9341(n)
		Case NPCTypeElias
			CreateNPCTypeElias(n)
		Case NPCtypeD
			;[Block]
			n\NVName = "Human"
			...
			n\obj = LoadAnimMesh_Strict("GFX\npcs\Humans\Personnel\Base_Human.b3d")
		...
		Case NPCTypeJanitor
			...
			n\obj = LoadAnimMesh_Strict("GFX\NPCs\Humans\Personnel\janitor_gasmask.b3d")
		...
		Case NPCType963_2
			...
			n\obj = LoadAnimMesh_Strict("GFX\NPCs\SCPs\963\963_2.b3d")
		...
		Case NPCtype049
			CreateNPCtype049(n)
		Case NPCtype049_2
			CreateNPCType049_2(n)
		Case NPCtype049_3
			CreateNPCType049_3(n)
		Case NPCtype049_4
			CreateNPCType049_4(n)
		Case NPCtype049_5
			CreateNPCType049_5(n)
		Case NPCType049_6
			CreateNPCType049_6(n)
		Case NPCtypeApache
			;[Block]
			n\NVName = "Human"
			n\GravityMult = 0.0
			...
			n\obj3 = LoadAnimMesh_Strict("GFX\map\apaches\apacherotor2.b3d",n\obj)
		...
		Case NPCtype860
			...
			EntityType n\Collider, HIT_PLAYER
			n\obj = LoadAnimMesh_Strict("GFX\npcs\SCPs\860\860.b3d")
			
			EntityFX(n\obj, 1)
			
			Local tex = LoadTexture_Strict("GFX\npcs\SCPs\860\860_eyes.png",1+2)
		...
		Case NPCtype066
			...
			n\obj = LoadAnimMesh_Strict("GFX\NPCs\SCPs\066\066.b3d")
		...
		Case NPCtype008_4
			;[Block]
			CreateNPCtype008_4(n)
			;[End Block]
		Case NPCtype008_5
			;[Block]
			CreateNPCtype008_5(n)
			;[End Block]
		Case NPCtype008
			;[Block]
			CreateNPCtype008(n)
		...
		Case NPCtype008_2
			;[Block]
			CreateNPCtype008_2(n)
			;[End Block]
		Case NPCtype008_3
			;[Block]
			CreateNPCtype008_3(n)
			;[End Block]
		Case NPCtypeD2
			;[Block]
			CreateNPCtypeD2(n)
...
Function UpdateNPCs()
	...
	For n.NPCs = Each NPCs
		...
		Select n\NPCtype
			...
			Case NPCtype049
				UpdateNPCtype049(n)
			Case NPCtype049_2,NPCType049_6
				UpdateNPCType049_2(n)
			Case NPCtype049_3
				UpdateNPCType049_3(n)
			Case NPCtype049_4
				UpdateNPCType049_4(n)
			Case NPCtype049_5
				UpdateNPCType049_3(n)
			Case NPCtypeGuard
				UpdateNPCtypeGuard(n)
			Case NPCTypeWoundedGuard
				UpdateNPCTypeWoundedGuard(n)
			Case NPCtypeNTF
				UpdateNPCtypeNTF(n)
			Case NPCTypePlotNTF
				UpdateNPCtypePlotNTF(n)
			Case NPCtypeCI
				UpdateNPCtypeCI(n)
			Case NPCTypeCITest
				updatenpctypecitest(n)
			Case NPCtypeD9341
				UpdateNPCtypeD9341(n)
			Case NPCTypeElias
				UpdateNPCTypeElias(n)
			Case NPCtypeD,NPCtypeClerk,NPCType963_2,NPCTypeJanitor
				;[Block]
			...
			Case NPCtype5131
				...
				If PlayerRoom\RoomTemplate\Name <> "pocketdimension" Then 
					...
					Else
						...
						If n\State2 > 0 Then
							If dist < PowTwo(4.0) Then n\State2 = n\State2-fps\Factor[0]*4
				...
				If RN$ <> "pocketdimension" Then 
					...
					Else
						...
						If EntityInView(n\obj, Camera) Then
							...
							MoveEntity n\Collider, 0, 0, 0.03*fps\Factor[0]
							
							n\State = n\State-fps\Factor[0]
						EndIf
						n\State=n\State-(fps\Factor[0]/80.0)
			...
			Case NPCtypeApache ;------------------------------------------------------------------------------------------------------------------
				...
				Select n\State
					Case 0,1
						TurnEntity(n\obj2,0,20.0*fps\Factor[0],0)
						TurnEntity(n\obj3,20.0*fps\Factor[0],0,0)
						
						If n\State=1 And (I_268\Using = 0 Lor I_268\Timer =< 0.0) Then
					...
					Case 2,3 ;player located -> attack
						...
						If (I_268\Using > 0 Lor I_268\Timer > 0.0) And n\State = 2 Then n\State = 1
										...
										If n\Reload =< 0 Then
											If dist<20.0 Then
												...
												If WrapAngle(EntityYaw(pvt)-EntityYaw(n\Collider))<10 Then
													...
													If PlayerRoom\RoomTemplate\Name = "exit1" Then
														m_msg\DeathTxt = Chr(34)+"CH-2 to control. Shot down "+Designation+" at Gate B."+Chr(34)
													Else
														m_msg\DeathTxt = Chr(34)+"CH-2 to control. Shot down "+Designation+" at Gate A."+Chr(34)
													EndIf
					...
					Case 4 ;crash
						If n\State2 < 300 Then
							...
							TurnEntity n\Collider,0,-fps\Factor[0]*7,0;Sin(MilliSecs()/40)*fps\Factor[0]
							...
							PointEntity n\obj, target
							MoveEntity n\obj, 0,0,fps\Factor[0]*0.001*n\State2
			...
			Case NPCtype860
				;[Block]
				If PlayerRoom\RoomTemplate\Name = "testroom_860" Then
					...
					Select n\State
						...
						Case 2 ;appears on the path and starts to walk towards the player
							...
							Else
								...
								If CurrSpeed > 0.03 Then ;the player is running
									...
									EndIf
								Else
									n\State3 = Max(n\State3 - fps\Factor[0],0)
								EndIf
								...
								If dist<4.5 Lor n\State3 > Rnd(200,250) Then
									...
									If (I_268\Using = 0 Lor I_268\Timer =< 0.0) Then
										n\State = 3
									Else
										If (prevFrame < 492 And n\Frame >= 492) Lor (prevFrame < 568 And n\Frame >= 568) Then
											SetNPCFrame(n, 2)
											n\State = 4
										EndIf
									EndIf
						...
						Case 3 ;runs towards the player and attacks
							...
							If (I_268\Using > 0 And I_268\Timer > 0) Then
								If (prevFrame < 315 And n\Frame >= 315) Lor (prevFrame < 492 And n\Frame >= 492) Then
									SetNPCFrame(n, 2)
									n\State = 4
								EndIf
							EndIf
						Case 4 ;Idles, but if appeared
							;[Block]
							n\CurrSpeed = 0
							
							AnimateNPC(n, 2, 199, 0.5)
							
							If (I_268\Using = 0 Lor I_268\Timer =< 0.0) Then n\State = 3
							;[End Block]
					End Select
										...
										Case 4
											If PlayerRoom\RoomTemplate\DisableDecals = False Then
												...
												If DistanceSquared(EntityX(Collider),EntityX(n\Collider),EntityZ(Collider),EntityZ(n\Collider))<PowTwo(0.8) Then
													...
													Else
														Damage1033RU(15 + 5 * SelectedDifficulty\AggressiveNPCs)
													EndIf
												EndIf
											EndIf
									End Select
			...
			Case NPCtype008
				UpdateNPCtype008(n)
			Case NPCtype008_2
				UpdateNPCtype008_2(n)
			Case NPCtype008_3
				UpdateNPCtype008_3(n)
			Case NPCtype008_4
				UpdateNPCtype008_4(n)
			Case NPCtype008_5
				UpdateNPCtype008_5(n)
			Case NPCtypeD2
				UpdateNPCtypeD2(n)
			Case NPCtypeTentacle
...
Function MeNPCSeesPlayer%(me.NPCs,disablesoundoncrouch%=False,disablesounddetect%=False)
	...
	If I_268\Using = 3 Then Return False
	
	PlayerDetected = False
	If (Not PlayerDetected) Lor me\NPCtype <> NPCtypeNTF
...
Function GetNPCWeaponAnim$(GunType%)
	...
	Select GunType
		Case GUNANIM_SMG
			Return "smg"
		Case GUNANIM_MP5K, GUNANIM_RIFLE
			Return "rifle"
		Case GUNANIM_PISTOL
			Return "pistol"
	...
	Select c_input$ 
		...
		Case "0083", "0083zombie"
			If gc\CurrGamemode = 3 Then
				...
				EndIf
			Else	
				n.NPCs = CreateNPC(NPCtype008_3, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
			EndIf
			n\State = 1
			consoleMSG = "SCP-008 infected human spawned."
		Case "0084", "0084zombie"
			If gc\CurrGamemode = 3 Then
				If mp_I\Gamemode\ID = Gamemode_Deathmatch Then
					CreateConsoleMsg("SCP-008 infected human cannot be spawned in Deathmatch. Sorry!", 255, 0, 0)
				Else
				...
				EndIf
			Else
				n.NPCs = CreateNPC(NPCtype008_4, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
			EndIf
			n\State = 1
			consoleMSG = "SCP-008 infected human spawned."
		Case "008sold", "zombiesolider"
			If gc\CurrGamemode = 3 Then
				If mp_I\Gamemode\ID = Gamemode_Deathmatch Then
					CreateConsoleMsg("SCP-008 infected human cannot be spawned in Deathmatch. Sorry!", 255, 0, 0)
				Else
				...
				EndIf
			Else
				n.NPCs = CreateNPC(NPCtype008_5, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
			EndIf
			n\State = 1
			consoleMSG = "SCP-008 infected human spawned."
		...
		Case "049-2", "0492", "scp-049-2", "scp049-2", "049zombie"
			...
			EndIf	
		Case "049-3", "0493", "scp-049-3", "scp049-3", "0493zombie"
			If gc\CurrGamemode = 3 Then
				If mp_I\Gamemode\ID = Gamemode_Deathmatch Then
				...
				EndIf
			Else
				n.NPCs = CreateNPC(NPCtype049_3, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				n\State = 1
				consoleMSG = "SCP-049-3 spawned."
			EndIf	
		Case "049-4", "0494", "scp-049-4", "scp049-4", "0494zombie"
			If gc\CurrGamemode = 3 Then
				If mp_I\Gamemode\ID = Gamemode_Deathmatch Then
					CreateConsoleMsg("SCP-049-4 cannot be spawned in Deathmatch. Sorry!", 255, 0, 0)
				Else	
					n.NPCs = CreateNPC(NPCtype049_2, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				EndIf
			Else
				n.NPCs = CreateNPC(NPCtype049_4, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				n\State = 1
				consoleMSG = "SCP-049-4 spawned."
			EndIf	
		Case "049-5", "0495", "scp-049-5", "scp049-5", "0495zombie"
			If gc\CurrGamemode = 3 Then
				If mp_I\Gamemode\ID = Gamemode_Deathmatch Then
					CreateConsoleMsg("SCP-049-5 cannot be spawned in Deathmatch. Sorry!", 255, 0, 0)
				Else	
					n.NPCs = CreateNPC(NPCtype049_2, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				EndIf
			Else
				n.NPCs = CreateNPC(NPCtype049_5, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				n\State = 1
				consoleMSG = "SCP-049-5 spawned."
			EndIf	
		Case "049-6", "0496", "scp-049-6", "scp049-6", "0496zombie"
			If gc\CurrGamemode = 3 Then
				If mp_I\Gamemode\ID = Gamemode_Deathmatch Then
					CreateConsoleMsg("SCP-049-6 cannot be spawned in Deathmatch. Sorry!", 255, 0, 0)
				Else	
					n.NPCs = CreateNPC(NPCtype049_2, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				EndIf
			Else
				n.NPCs = CreateNPC(NPCType049_6, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				n\State = 1
				consoleMSG = "SCP-049-6 spawned."
			EndIf	
		...
		Case "mtf", "mobiletaskforce"
			If gc\CurrGamemode = 3 Then
				CreateConsoleMsg("MTF cannot be spawned in Multiplayer. Sorry!", 255, 0, 0)
			Else
				n.NPCs = CreateNPC(NPCtypeNTF, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				consoleMSG = "MTF unit spawned."
			EndIf
		Case "mtfmedic", "mobiletaskforcemedic", "pizzaday"
			If gc\CurrGamemode = 3 Then
				CreateConsoleMsg("MTF cannot be spawned in Multiplayer. Sorry!", 255, 0, 0)
			Else
				n.NPCs = CreateNPC(NPCtypeNTF, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
		...
		Case "d2","aggressive_d","classd2","class-d2"
			...
			EndIf	
		Case "d9341","benj","classd9341","class-d9341","oliver","benjaminoliver"
			If gc\CurrGamemode = 3 Then
			...
			EndIf
		Case "ci","chaosinsurgency","chaos","ins"
			If gc\CurrGamemode = 3 Then
		...
		Case "citest"
			If gc\CurrGamemode = 3 Then
				CreateConsoleMsg("Chaos Insurgent cannot be spawned in Multiplayer. Sorry!", 255, 0, 0)
			Else
				n.NPCs = CreateNPC(NPCTypeCITest, EntityX(Collider), EntityY(Collider) + 0.2, EntityZ(Collider))
				consoleMSG = "Chaos Insurgent test spawned."
			EndIf
		...
		Case "035", "scp-035", "scp035"
			...
			Else
				CreateConsoleMsg("SCP-035 cannot be spawned in Deathmatch. Sorry!", 255, 0, 0)
			EndIf
...
Function NPCSpeedChange(n.NPCs)
	...
	Select n\NPCtype
		Case NPCtype173,NPCtype106,NPCtype096,NPCtype049,NPCtype939,NPCtype076,NPCtype682
...
Function PlayerInReachableRoom(canSpawnIn049Chamber=False)
	...
	If RN = "pocketdimension" Lor RN = "gate_a_topside" Lor RN = "gate_c_topside" Lor RN = "gate_a_road" Lor RN = "gate_c_topside" Lor RN = "gate_d_topside" Lor RN = "gate_b_topside" Lor RN = "gate_a_intro" Then
		Return False
	EndIf
...
Function IsNPCStuck(n.NPCs,time#)
	...
	timer=Max(timer-fps\Factor[0],0.0)
...
Function NPC_GoTo(n.NPCs, IdleAnim.Vector3D, MoveAnim.Vector3D, path_target%, n_speed#=0.0)
	...
	If n\PathStatus = 1 Then
			...
			If n\Path[n\PathLocation]\door<>Null Then
				If (Not n\Path[n\PathLocation]\door\IsElevatorDoor) Then
					...
					Else
						...
						If n\NPCtype = NPCtypeNTF And n\Path[n\PathLocation]\door\open = False Then PlaySound2(LoadTempSound("SFX\Character\MTF\Beep.ogg"), Camera, n\Collider)
					EndIf
				EndIf
			EndIf
		...
		EndIf
	Else
		n\PathTimer = Max(0, n\PathTimer-fps\Factor[0])
...
Function NPCSeesEntityFar(n.NPCs, target)
	If EntityVisible(n\Collider, target) Then
		Return True
	EndIf
...
Function SwitchNPCGun%(n.NPCs, WeaponName$)
	CatchErrors("SwitchNPCGun(" + n\NPCtype + ", " + WeaponName + ")")
	Local g.Guns
	Local bone%
	...
	If WeaponName <> "" Then
		Scale# = GetINIFloat(gv\WeaponFile, WeaponName, "world scale", 0.02) / EntityScaleX(n\obj)
		ScaleEntity n\Gun\obj,Scale,Scale,Scale
		
		VectorString = GetINIString(gv\WeaponFile, WeaponName, "npc_model_offset", "")
		If VectorString <> "" Then
			PositionEntity n\Gun\obj, Piece(VectorString,1,"|"), Piece(VectorString,2,"|"), Piece(VectorString,3,"|")
		EndIf
		VectorString = GetINIString(gv\WeaponFile, WeaponName, "npc_model_rotation", "")
		If VectorString <> "" Then
	...
	CatchErrors("Uncaught (SwitchNPCGun(" + n\NPCtype + ", " + WeaponName + "))")
End Function
				...
				Select target\NPCtype
					...
					Case NPCtype049_2,NPCType049_6
						If target\State = Z_STATE_WANDER Then
							Return True
						EndIf
					Case NPCtype008,NPCtype008_2,NPCtype008_3,NPCtype049_3,NPCtype049_4,NPCtype049_5,NPCtype008_4
					...
					Case NPCtype1048a
						Return True
				End Select
			Case NPCtypeCI, NPCTypeFriendlyCI
				Select target\NPCtype
					Case NPCTypeNTFEnemy
						Return True
					Case NPCtypeCI
						Return True
					Case NPCtypeNTF
...
Function PreloadAllNPCAnimations()
	...
	PreloadNPCAnimation(NPCtypeD2, "Class-D", "smg_idle")
	PreloadNPCAnimation(NPCtypeD2, "Class-D", "smg_walk")
	PreloadNPCAnimation(NPCtypeD2, "Class-D", "smg_reload")
	PreloadNPCAnimation(NPCtypeD2, "Class-D", "surrender")
	; ~ D-9341
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "idle")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "walk")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "death_front")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "death_back")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "death_left")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "death_right")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "pistol_idle")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "pistol_walk")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "pistol_reload")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "rifle_idle")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "rifle_walk")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "rifle_reload")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "shotgun_idle")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "shotgun_walk")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "shotgun_reload")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "smg_idle")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "smg_walk")
	PreloadNPCAnimation(NPCtypeD9341, "Class-D", "smg_reload")
	; ~ Chaos Insurgency
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "idle")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "walk")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "death_1")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "death_2")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "death_3")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "pistol_idle")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "pistol_walk")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "pistol_reload")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "rifle_idle")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "rifle_walk")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "rifle_reload")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "shotgun_idle")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "shotgun_walk")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "shotgun_reload")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "smg_idle")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "smg_walk")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "smg_reload")
	PreloadNPCAnimation(NPCtypeCI, "Chaos Insurgency", "throw_grenade")
